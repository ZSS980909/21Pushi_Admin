...
public class WebUtils {
    ...
    public final static String UA_KEY = "user-agent";
    ...
    public static String encodeHttpBasic(String userName, String password) {
        ...
        return "Basic " + Base64.encode(encode.getBytes());
    }
    ...
    public static String getUa(){
        return getHttpHeaders().get(UA_KEY);
    }

    public static String getHttpServletRequestAuthorization(){
        return getHttpHeaders().get(AUTH_KEY);
    }

    public static Map<String, String> getHttpHeaders(){
        return getHttpHeaders(getHttpServletRequest());
    }
